...
def run_async_safe(coro):
	"""
	Safely run async coroutine in both sync and async contexts.
	Handles event loop conflicts in tests.
	"""
	try:
		# Try to get existing event loop
		loop = asyncio.get_event_loop()
		if loop.is_running():
			# We're in an async context (tests), create new task
			return asyncio.create_task(coro)
		else:
			# We're in sync context, run normally
...
async def get_my_assets(
	...
	try:
		...
		# Continue anyway, just return current data
...
async def create_asset(
	...
	# Update asset prices and portfolio value - but handle gracefully in tests
	from assets.assets_updater import update_user_assets_prices
	from statistics.portfolio_value_updater import update_user_portfolio_value
	...
	try:
		...
		print(f"Warning: Could not update prices after creation: {e}")
...
async def update_asset(
	...
	# Update prices - handle gracefully
	from assets.assets_updater import update_user_assets_prices
	from statistics.portfolio_value_updater import update_user_portfolio_value
	...
	try:
		...
		print(f"Warning: Could not update prices after update: {e}")
...
async def delete_asset(
	...
	try:
		...
		print(f"Warning: Could not update prices after deletion: {e}")
...
async def close_asset(
	...
	try:
		...
		print(f"Warning: Could not update prices after closing: {e}")
